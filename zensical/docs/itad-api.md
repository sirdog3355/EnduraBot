...
- `/games/lookup/v1` ([ItadGameSearchHandler](itad-get-games-handler-class.md))
- `/games/info/v2` ([ItadGameSearchHandler](itad-get-games-handler-class.md))
- `/games/prices/v3` ([ItadGameDealsHandler](itad-get-deals-handler-class.md))
